import requests
import json
token = "778812767:AAEVVHbTzWXatma7-2r3Deyr5nGniKHs57w"
...
def get_city_id(s_city_name):
        try:
            ...
            params={'q': s_city_name, 'type': 'like', 'units': 'metric', 'lang': 'ru', 'APPID': "adade9bec6f77be63bd24271575e2d97"})
            data = res.json()
...
def get_pogoda(city):
    ...
    res = requests.get("http://api.openweathermap.org/data/2.5/weather",
                 params={'id': city, 'units': 'metric', 'lang': 'ru', 'APPID': "adade9bec6f77be63bd24271575e2d97"})
    data=res.json()
    temp=data['main']['temp']
